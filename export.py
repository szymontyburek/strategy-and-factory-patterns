...
# os.makedirs("exports", exist_ok=True) creates the "exports" directory if it doesn't exist
# exist_ok=True prevents an error if the directory already exists, making it safe to run multiple times
